...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	updateService := service.ProvideUpdateService(configConfig, serviceBuildInfo)
	...
	claudeCLIVersionSyncService := service.ProvideClaudeCLIVersionSyncService(settingRepository, gitHubReleaseClient)
