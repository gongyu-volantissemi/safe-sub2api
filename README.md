...
git clone https://github.com/gongyu-volantissemi/safe-sub2api.git
cd safe-sub2api
...
└── deploy/                   # Deployment files
    ├── config.example.yaml   # Full config file, copy to backend/config.yaml
    ├── sub2api.service       # systemd unit for running the built binary
