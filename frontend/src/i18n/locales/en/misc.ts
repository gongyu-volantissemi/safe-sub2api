export default {
  ...
  version: {
    ...
    upToDate: 'No active security warnings.',
    securityWarningsPresent: 'This instance has insecure config settings active',
    updatesViaGitPull: 'Updates: git pull + rebuild (see FORK_MAINTENANCE.md)',
    refresh: 'Refresh',
